    ...
    setMessage() {
        ...
        switch (this.props.messageView) {
            ...
            case "confirm_account-success":
                ...
                message = `Уважаемый ${this.props.username}! На Ваш почтовый ящик было выслано повторное письмо с подтверждением учётной записи.`;
                break;
            case "confirm_account-invalid":
                title = "Ошибка";
                message = `Уважаемый ${this.props.username}! При отправке по электронной почте уведомления о подтверждении аккаунта, произошла ошибка. ` +
