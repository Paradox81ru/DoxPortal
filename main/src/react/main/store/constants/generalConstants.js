...
const CHANGE_MAIN_MENU = "CHANGE_MAIN_MENU";
/** Сбрасывает главное меню расположенное в левом сайдбаре то стандартного меню гостя */
const RESET_MAIN_MENU = "RESET_MAIN_MENU";
/** Добавляет системное сообщение */
const ADD_SYSTEM_MESSAGE = "ADD_MESSAGE";
